				...
				<div class="container">
					...
					<div class="row">
						...
						<form:form commandName="order" class="form-horizontal">
							...
							<div
								class="well1 col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-sm-offset-1 col-md-offset-3">
									...
									<table class="table">
										...
										<tbody>
											<c:forEach var="cartItem" items="${order.cart.cartItem}">
												<tr>
													<td class="col-md-9"><em>${cartItem.product.brand}</em></td>
											...
											<tr>
												...
												<td class="text-center">
													<h4>
														<strong>INR ${order.cart.totalPrice}</strong>
													</h4>
												</td>
											</tr>
								...
								<input type="submit" value="Submit Order"
									class="btn btn-warning" name="_eventId_orderConfirmed" />

...
public class ProductController {
	...
	public String deleteProduct(@PathVariable(value = "isbn") int isbn) {
		...
		Path paths = Paths
				.get("G:\\2nd prj wrkspace\\springweb\\src\\main\\webapp\\WEB-INF\\resources\\images\\" + isbn + ".png");
	...
	public String addProduct(@Valid@ModelAttribute(value = "productFormObj") Product product, BindingResult result) {
		...
		if (productImage != null && !productImage.isEmpty()) {
			Path paths = (Path) Paths.get("G:\\2nd prj wrkspace\\springweb\\src\\main\\webapp\\WEB-INF\\resources\\images\\"
					+ product.getIsbn() + ".png");
			try {
